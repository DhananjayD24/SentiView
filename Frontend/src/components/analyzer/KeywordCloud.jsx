      ...
      <div className="flex flex-wrap gap-2 sm:gap-2">
        {keywords.map((item, index) => (
          <span
            key={index}
            className={cn(
              "px-2.5 sm:px-3 py-1.5 rounded-full text-xs sm:text-sm font-medium transition-all duration-200 hover:scale-105 whitespace-normal break-words max-w-full",
              type === "positive"
